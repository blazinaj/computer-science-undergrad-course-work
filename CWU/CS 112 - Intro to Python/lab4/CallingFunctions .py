...
#3.find the index location of minimum value
number, index = minValue(numbers)
print("The min value is ", number, ", it's at index ", index)

#4 find the index location of max value
number, index = maxValue(numbers)
print("The max value is ", number, ", it's at index ", index)
